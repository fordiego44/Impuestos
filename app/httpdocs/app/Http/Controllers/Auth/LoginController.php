...
class LoginController extends Controller
{
    ...
    public function register(Request $request) {
        ...
        if (isset($validator->email_register) || isset($validator->names) || isset($validator->email) || isset($validator->password) || isset($validator->password_confirmation) ||  isset($validator->password_equal)) {
    ...
    public function loginRepartidor (Request $request) {
        ...
        if (isset($validator->email) || isset($validator->password) || isset($validator->email_register ))  {
            ...
            $deliever = Deliverier::where('email', $request->email)->first();
            if(isset($deliever)) {
    ...
    public function viewLogin(){
        ...
        return view('auth.login')->with(compact('bussines'));
    }

    public function viewLoginRepartidor(){
        $bussines = DB::table('bussines')->get();
        return view('auth.login-repartidor')->with(compact('bussines'));
    }
    public function viewLoginAdmin() {
        $bussines = DB::table('bussines')->get();
        return view('auth.login-admin')->with(compact('bussines'));    
    }
