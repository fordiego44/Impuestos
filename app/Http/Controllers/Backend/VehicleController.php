...
class VehicleController extends Controller
{
    ...
    {
        $vehicles = Vehicle::orderBy('id', 'desc')->where('user', session('user')->id)->where('state_delete','0')->get();
    ...
    public function newvehicle(){
        ...
        $deliverys = Deliverier::orderBy('id', 'desc')->where('id_user', session('user')->id)->where('state_delete','0')->get();
