...
export class Button extends BaseElement {
    ...
    getElementString() {
        ...
        return `<a class="casaroyal-btn pxp-primary-cta text-uppercase mt-5 pxp-animate" data-action="properties" data-page="${this.link}" ${this.disable} id="${this._id}">
                    <i data-action="properties" data-page="${this.link}" class="fa fa-spinner fa-spin fa-3x fa-fw"></i>
                    <span data-action="properties" data-page="${this.link}">${this.title}</span>
                </a>`;
