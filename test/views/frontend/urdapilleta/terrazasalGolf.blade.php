...
<div class="pxp-cta-1 pxp-cover  pt-300" style="background-image: url(/images/landings/terrazas-al-golf-port.jpg); background-position: 50% 60%;">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-5 col-lg-5">
                <div class="pxp-cta-1-caption pxp-animate-in pxp-in">
                    <h2 class="pxp-section-h2">Barrio Cerrado Terrazas al Golf</h2>
                    <p class="pxp-text-light">El Lugar para Vivir.</p>
                    <!-- <a href="/buscar/propiedades-en-alquiler-en-26685-v" class="pxp-primary-cta text-uppercase mt-3 mt-md-5 pxp-animate">Todas las propiedades en <strong>Terrazas al Golf</strong></a> -->
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid pxp-props-carousel-right mt-100">
    <h2 class="pxp-section-h2">Propiedades en Terrazas al Golf</h2>
...
<div class="pxp-content">
    ...
    <div class="pxp-blog-posts pxp-content-wrapper mt-60">
        <div class="container mt-100">
            <div class="row">
                <div class="col-sm-12 col-md-7">
                    <h4>Aún no conocés Terrazas al Golf?</h4>
                    <h1 class="pxp-page-header">Conocé todos los departamentos en Venta y Alquiler en el Condominio Terrazas al Golf </h1>
                </div>
            </div>
        </div>
                ...
                <div class="pxp-services-container rounded-lg mt-4 mt-md-5">
                    ...
                    <!-- <a href="{{asset('/masterplan/pilara.pdf')}}" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Conocé los barrios que<br> integran a Terrazas al Golf</div>
                        </div>
                    ...
                    <a href="https://goo.gl/maps/HALqzqCfoMgrU11D8" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Desde Google Maps conocé <br/>como llegar a Terrazas al Golf.</div>
                        </div>
                    ...
                    <a href="https://wa.me/5491161124558" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            <div class="pxp-services-item-text-title">Te gustaría Visitar Terrazas al Golf?</div>
                            <div class="pxp-services-item-text-sub">Hablemos Vía <Strong>Whatsapp</strong> <br>para que vengas a conocer Terrazas al Golf.</div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-10">
                    <div class="pxp-blog-post-block mt-4 mt-md-5 mt-lg-0">
                        <h2>Terrazas al Golf, Pilará.</h2>
                        <div class="mt-3 mt-md-4">
                            <p >Unidades únicas de 2, 3 y 4 ambientes en el corazón del golf de Pilará </p>
                        </div>
                    ...
                    <div class="pxp-blog-post-block pxp-full mt-4 mt-md-5">
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <img src={{asset('/images/landings/terrazas-mapa.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
                            
                            <!-- <div class="col-sm-12 col-md-6">
                                <img src={{asset('/images/landings/Terrazas al Golf-2.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div> -->
                    ...
                    <!-- <div class="pxp-blog-post-block mt-4 mt-md-5">
                        <h2>Servicios del barrio Terrazas al Golf: </h2>
                        <div class="mt-3 mt-md-4">
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        <h2>Infraestructura del barrio Terrazas al Golf: </h2>
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Unidades únicas de 2, 3 y 4 ambientes en el corazón del golf de Pilará</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Jardín central y pileta.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Doble cochera subterránea por unidad. bauleras propias.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Acceso directo desde cochera a la unidad por ascensor.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Grandes livings apaisados.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span>  Terrazas y parrillas propias..</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span>  Excelentes Terminaciones</div>
                                </div>
                        ...
                        <!-- <div class="mt-3 mt-md-4">
                            <h2>Ubicación de Terrazas al Golf </h2>
        ...
        <div class="pxp-blog-post-hero mt-4 mt-md-5">
            <div class="pxp-blog-post-hero-fig pxp-cover" style="background-image: url(/images/landings/terrazas-al-golf-port.jpg); background-position: 50% 60%;"></div>
        </div>
