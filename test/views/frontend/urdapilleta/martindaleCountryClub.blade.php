        ...
        <div class="container mt-100">
            <div class="row">
                <div class="col-sm-12 col-md-7">
                    <h4>Aún no conocés Martindale Country Club?</h4>
                    <h1 class="pxp-page-header">Conocé las características de Martindale Country Club. </h1>
                </div>
            </div>
        </div>
                ...
                <div class="pxp-services-container rounded-lg mt-4 mt-md-5">
                    ...
                    <!-- <a href="{{asset('/masterplan/pilara.pdf')}}" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Conocé los barrios que<br> integran a Martindale Country Club</div>
                        </div>
                    ...
                    <a href="https://goo.gl/maps/MqNC5i912gBWbgwY6" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Desde Google Maps conocé <br/>como llegar a Martindale Country Club.</div>
                        </div>
                    ...
                    <a href="https://wa.me/5491151856532" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            <div class="pxp-services-item-text-title">Te gustaría Visitar Martindale Country Club?</div>
                ...
                <div class="col-sm-12 col-lg-10">
                    <div class="pxp-blog-post-block mt-4 mt-md-5 mt-lg-0">
                        ...
                        <div class="mt-3 mt-md-4">
                            <p class="pxp-first-letter">Martindale Country Club fue construido en 1989, es uno de los primeros counties de Pilar. Es uno de los barrios más tradicionales de la zona, con grandes espacios verdes y espectaculares arboladas.  </p>
                        </div>
                         <div class="mt-3 mt-md-4">
                            <p>Martinadle se distingue por tener una de las canchas de golf más importantes de la República Argentina, además de otra cancha de 9 hoyos de par 3, ideal para quienes comienzan en el apasionante mundo del golf.  </p>
                        </div>
                        
                        <div class="pxp-blog-post-blockquote pxp-left">"Superficie total de 380 hectáreas, divididas en 695 lotes de entre 1.100 y 2.500 m2"</div>
                        
                        <div class="mt-3 mt-md-4">
                            <p>La actividad ecuestre es una parte fundamental en la historia del Club. La actividad de Polo en Martindale es muy intensa, está registrada en la Asociación Argentina de Polo y se realiza en las 5 canchas reglamentarias. Asimismo, la equitación es otra de las actividades de gran importancia en Martindale, por lo que las instalaciones (pistas, boxes, picadero) se mantienen en un excelente nivel. </p>
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        ...
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Superficie total de 380 hectáreas, divididas en 695 lotes de entre 1.100 y 2.500 m2.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> 5 Canchas de Fútbol y Cancha de Jockey</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Equitación</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                        ...
                        <div class="mt-3 mt-md-4">
                        <h2>Ubicación de Martindale Country Club </h2>
                            <p>Se encuentra ubicado en Pilar, sobre la Avenida Juan Domingo Perón, a pocos metros del Hospital Austral. </p>
                        </div>
