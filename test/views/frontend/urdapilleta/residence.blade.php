...
<div class="pxp-cta-1 pxp-cover  pt-300" style="background-image: url(/images/landings/residence-port.jpg); background-position: 50% 60%;">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-5 col-lg-5">
                <div class="pxp-cta-1-caption pxp-animate-in pxp-in">
                    <h2 class="pxp-section-h2">Barrio Cerrado Residences</h2>
                    <p class="pxp-text-light">El Lugar para Vivir.</p>
                    <a href="../buscar/propiedades-en-urdapilleta-en-26724-r" class="pxp-primary-cta text-uppercase mt-3 mt-md-5 pxp-animate">Todas las propiedades en <strong>Residences</strong></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid pxp-props-carousel-right mt-100">
    <h2 class="pxp-section-h2">Propiedades en Residences</h2>
    <p class="pxp-text-light">Ver propiedades en: <a style="color: #729acd; cursor: pointer;"  id='en-venta' >En Venta</a> | <a style="color: #729acd; cursor: pointer;"  id='en-alquiler'>En Alquiler</a> | <a href="../buscar/propiedades-en-urdapilleta-en-26724-r">Ver Todas</a></p>
...
<div class="pxp-content">
        ...
        <div class="container mt-100">
            <div class="row">
                <div class="col-sm-12 col-md-7">
                    <h4>Aún no conocés Residences?</h4>
                    <h1 class="pxp-page-header">Conocé todos los departamentos en Venta y Alquiler en el Condominio Residences </h1>
                </div>
            </div>
        </div>
                ...
                <div class="pxp-services-container rounded-lg mt-4 mt-md-5">
                    ...
                    <!-- <a href="{{asset('/masterplan/pilara.pdf')}}" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Conocé los barrios que<br> integran a Residences</div>
                        </div>
                        <div class="pxp-services-item-cta text-uppercase text-center">Descargar Mapa</div>
                    </a> -->
                    <a href="https://goo.gl/maps/HALqzqCfoMgrU11D8" target="_blank" class="pxp-services-item">
                        <div class="pxp-services-item-fig">
                            <img src={{asset('images/plan-business.svg')}}>
                        </div>
                        <div class="pxp-services-item-text text-center">
                            <div class="pxp-services-item-text-title">Como llegar</div>
                            <div class="pxp-services-item-text-sub">Desde Google Maps conocé <br/>como llegar a Residences.</div>
                        </div>
                    ...
                    <a href="https://wa.me/5491151856532" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            <div class="pxp-services-item-text-title">Te gustaría Visitar Residences?</div>
                            <div class="pxp-services-item-text-sub">Hablemos Vía <Strong>Whatsapp</strong> <br>Te esperamos en Residences.</div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-10">
                    <div class="pxp-blog-post-block mt-4 mt-md-5 mt-lg-0">
                        <h2>Condominio Residences</h2>
                        <div class="mt-3 mt-md-4">
                            <p class="pxp-first-letter">Condominios de excelencia, en un entorno de arboladas y lagunas, frente a la exclusiva cancha de golf Signatue. </p>
                        </div>
                         <div class="mt-3 mt-md-4">
                            <p>Cuenta con 73 unidades de 2, 3 y 4 ambientes con balcón o jardín propio en planta baja, todos con parrillas individuales y hermosas vistas en un lote de 10.200 metros cuadrados de superficie.    </p>
                        </div>
                    </div>
                    ...
                    <!-- <div class="pxp-blog-post-block pxp-full mt-4 mt-md-5">
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <img src={{asset('/images/landings/residences-1.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
                            
                            <div class="col-sm-12 col-md-6">
                                <img src={{asset('/images/landings/residences-2.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
 ...
 -->
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        <h2>Unidadades de Residences: </h2>
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> 2 AMBIENTES: 50 a 60 m2</div>
                                </div>
                                 <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> 3 AMBIENTES: 80 a 90 m2</div>
                                </div>
                                 <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> 4 AMBIENTES: 90 a 120 m2</div>
                                </div>
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        <h2>Infraestructura del barrio Residences: </h2>
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Pisos y revestimientos en porcelanato rectificado de primera calidad.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Artefactos de baño Ferrum o similar.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Griferias FV o similar.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Carpinterías Exteriores de aluminio anodizado línea</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Carpinterías de piso a techo en living comedor.</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Balcón terraza con parrilla individual.</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Mesadas de baño mármol.</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Mesada de cocina "Silestone" o similar.</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Pileta de acero inoxidable doble, modelo "Luxor" de Johnson o similar.</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Anafe y horno eléctrico de acero inoxidable, marca Glem o similar.</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Sistema de calefacción por piso radiante en todos los ambientes.</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Frentes de placard con puertas corredizas enmarcadas en aluminio, frente de melamina y espejo</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Domotización del sistema de calefacción mediante termostato "Nest" en living comedor.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Vigilancia por CCTV.</div>
                                </div>
                        ...
                        <div class="mt-3 mt-md-4">
                        <h2>Ubicación de Residences </h2>
                            <p>Dentro de Ayres Vila, ubicado en el Km 43 de la Panamericana Ramal Pilar. </p>
                        </div>
        ...
        <div class="pxp-blog-post-hero mt-4 mt-md-5">
            <div class="pxp-blog-post-hero-fig pxp-cover" style="background-image: url(/images/landings/residence-port.jpg); background-position: 50% 60%;"></div>
        </div>
