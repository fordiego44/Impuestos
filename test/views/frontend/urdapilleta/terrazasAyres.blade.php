        ...
        <div class="container mt-100">
            <div class="row">
                <div class="col-sm-12 col-md-7">
                    <h4>Aún no conocés Terrazas de Ayres?</h4>
                    <h1 class="pxp-page-header">Conocé todos los departamentos en venta y alquiler en el Condominio Terrazas de Ayres </h1>
                </div>
            </div>
        </div>
                ...
                <div class="pxp-services-container rounded-lg mt-4 mt-md-5">
                    ...
                    <!-- <a href="{{asset('/masterplan/pilara.pdf')}}" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Conocé los barrios que<br> integran a Terrazas Ayres</div>
                        </div>
                    ...
                    <a href="https://goo.gl/maps/QL2beT7BiCmxchZ47" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Desde Google Maps conocé <br/>como llegar a Terrazas Ayres.</div>
                        </div>
                    ...
                    <a href="https://wa.me/5491151856532" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            <div class="pxp-services-item-text-title">Te gustaría Visitar Terrazas Ayres?</div>
                            <div class="pxp-services-item-text-sub">Hablemos Vía <Strong>Whatsapp</strong> <br>Te esperamos en Terrazas Ayres.</div>
                        </div>
                ...
                <div class="col-sm-12 col-lg-10">
                    <div class="pxp-blog-post-block mt-4 mt-md-5 mt-lg-0">
                        ...
                        <div class="mt-3 mt-md-4">
                            <p class="pxp-first-letter">Este proyecto se encuentra dentro de Ayres Vila, un espacio de 17 hectáreas con desarrollos que ofrecen soluciones de vivienda, oficinas y comercios. Ayres Vila es un centro urbano, ubicado en el Km 43 de la Panamericana Ramal Pilar, que propone otro estilo de vida.  </p>
                        </div>
                        <div class="pxp-blog-post-blockquote pxp-left">Más de 80% del lote destinado a espacios verdes y comunes</div>
                        <div class="mt-3 mt-md-4">
                            <p>El Master Plan realizado por Ayres Desarrollos, incluye viviendas (Home Area), oficinas (Business Area) y áreas de esparcimientos (Urban Area). Dentro del predio se encuentran: Terrazas de Ayres, Loft en Ayres Vila, Vilahaus, Skyglass, Skyglass 2 y Skyglass 3, y STUDIOS un desarrollo diseñado para trabajar o vivir, cuya entrega está planeada para noviembre 2020. </p>
                        </div>
                    </div>
                        ...
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Living comedor, con amplia vista al jardín.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Cocina</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Dormitorio principal en suite con balcón, toilette y un segundo dormitorio.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Galería con parrilla.</div>
                                </div>
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        ...
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> 11 módulos de 12 departamentos cada uno.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> 4 departamentos por piso.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Construido sobre terreno de 3 hectáreas.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Más de 80% del lote destinado a espacios verdes y comunes</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        ...
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Perímetro preparado para circuito cerrado de TV.</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
