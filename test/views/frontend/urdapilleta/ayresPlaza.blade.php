...
<div class="pxp-cta-1 pxp-cover  pt-300" style="background-image: url(/images/landings/ayresplaza-port.jpg); background-position: 50% 60%;">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-5 col-lg-5">
                <div class="pxp-cta-1-caption pxp-animate-in pxp-in">
                    <h2 class="pxp-section-h2">Barrio Cerrado Ayres Plaza</h2>
                    <p class="pxp-text-light">El Lugar para Vivir.</p>
                    <a href="../buscar/propiedades-en-urdapilleta-en-ag-pilar--gp-ayresplaza" class="pxp-primary-cta text-uppercase mt-3 mt-md-5 pxp-animate">Todas las propiedades en <strong>Ayres Plaza</strong></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid pxp-props-carousel-right mt-100">
    <h2 class="pxp-section-h2">Propiedades en Ayres Plaza</h2>
    <p class="pxp-text-light">Ver propiedades en: <a style="color: #729acd; cursor: pointer;"  id='en-venta' >En Venta</a> | <a style="color: #729acd; cursor: pointer;"  id='en-alquiler'>En Alquiler</a> | 
        <a href="../buscar/propiedades-en-urdapilleta-en-ag-pilar--gp-ayresplaza">Ver Todas</a></p>
        ...
        <div class="owl-carousel pxp-props-carousel-right-stage" id='container-barrio'>
            ...
            <a href="{{ route('frontend.property.detail' , ['sluglify' => $property->id . '-' .$property->title_href]) }}" class="pxp-prop-card-1 rounded-lg">
                ...
                <div class="pxp-prop-card-1-details">
                    <div class="pxp-prop-card-1-details-title">{{$property->publication_title}}</div><!-- (tipo de propioedad) en (tipo de operación) en Ayres Plaza -->
...
<div class="pxp-content">
    ...
    <div class="pxp-blog-posts pxp-content-wrapper mt-60">
        <div class="container mt-100">
            <div class="row">
                <div class="col-sm-12 col-md-7">
                    <h4>Aún no conocés Ayres Plaza?</h4>
                    <h1 class="pxp-page-header">Conocé Ayres Plaza. Bienvenido. </h1>
                </div>
            </div>
        </div>
        ...
        <div class="pxp-services pxp-cover mt-60 pt-100 mb-200" style="background-image: url(/images/testim-1-fig.jpg);">
            ...
            <div class="container">
                <div class="pxp-services-container rounded-lg mt-4 mt-md-5">
                    <a href="{{asset('/masterplan/MASTERPLAN-AYRES-PLAZA.pdf')}}" target="_blank" class="pxp-services-item">
                    ...
                    <!-- <a href="{{asset('/masterplan/pilara.pdf')}}" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Conocé los barrios que<br> integran a Ayres Plaza</div>
                        </div>
                        <div class="pxp-services-item-cta text-uppercase text-center">Descargar Mapa</div>
                    </a> -->
                    <a href="https://goo.gl/maps/w2TPNzoVGfTW573A" target="_blank" class="pxp-services-item">
                        <div class="pxp-services-item-fig">
                            <img src={{asset('images/plan-business.svg')}}>
                        </div>
                        <div class="pxp-services-item-text text-center">
                            <div class="pxp-services-item-text-title">Como llegar</div>
                            <div class="pxp-services-item-text-sub">Desde Google Maps conocé <br/>como llegar a Ayres Plaza.</div>
                        </div>
                    ...
                    <a href="https://wa.me/5491151856532" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            <div class="pxp-services-item-text-title">Te gustaría Visitar Ayres Plaza?</div>
                ...
                <div class="col-sm-12 col-lg-10">
                    <div class="pxp-blog-post-block mt-4 mt-md-5 mt-lg-0">
                        ...
                        <div class="mt-3 mt-md-4">
                            <p class="pxp-first-letter">Ayres Plaza es un barrio privado de categoría, con lotes de 600m2 a 900m2 y acceso directo desde Panamericana en el Km 47 del Ramal Pilar.  </p>
                        </div>
                         <div class="mt-3 mt-md-4">
                            <p>Su diseño está pensado con el concepto de “volver a las plazas”, es decir que dentro del predio hay 16 plazas, cada una con su propio diseño. Además, Ayres Plaza cuenta con una infraestructura deportiva muy completa: canchas de tenis y de fútbol, actividades recreativas para grandes y chicos, pileta con solárium y Club House.  </p>
                        </div>
                        <div class="mt-3 mt-md-4">
                            <p>El barrio Ayres Plaza, inaugurado en 2013, es un proyecto de Ayres Desarrollos, tiene una excelente ubicación, múltiples servicios, casas para comprar o alquilar, y varios lotes en venta.</p>
                    ...
                    <div class="pxp-blog-post-block pxp-full mt-4 mt-md-5">
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <img src={{asset('/images/landings/ayresplaza-1.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
                            
                            <div class="col-sm-12 col-md-7">
                                <img src={{asset('/images/landings/ayresplaza-2.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        <h2>Servicios del barrio Ayres Plaza </h2>
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                                <div class="col-sm-6 col-lg-4">
                                 ...
                                 <div class="col-sm-6 col-lg-4">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Control de acceso y seguridad 24hs con circuito de cámaras</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        <h2>Infraestructura del barrio Ayres Plaza </h2>
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> 300 lotes entre 600 y 900 m2</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> 16 plazas internas, para uso común</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Canchas de fútbol 11</div>
                                </div>
                                 <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Canchas de fútbol 5</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span>  6 canchas de tenis</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span>Pileta </div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Club House con restaurante </div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                        ...
                        <div class="mt-3 mt-md-4">
                        <h2>Alrededores de Ayres Plaza </h2>
                            <p>Ayres Plaza tiene salida directa a Panamericana, está a 3 minutos de importantes Centros Comerciales, prestigiosos Centros Médicos, excelentes Colegios y Universidades, y una amplia variedad de oferta gastronómica. </p>
                        </div>
        ...
        <div class="pxp-blog-post-hero mt-4 mt-md-5">
            <div class="pxp-blog-post-hero-fig pxp-cover" style="background-image: url(/images/landings/ayresplaza-port.jpg); background-position: 50% 60%;"></div>
        </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/axios/0.19.2/axios.js"></script>
    <script>
        $('#en-venta').on('click', async function() { 
            let page = 1; 
            let {  data: data } = await axios.get(`/api/development/buscar/propiedades-en-venta-en-26663-a?page=${page}`)
        ...
        $('#en-alquiler').on('click',async function() {
            ...
            let page = 1; 
             let {  data: data } = await axios.get(`/api/development/buscar/propiedades-en-alquiler-en-26663-a?page=${page}`)
            $("input[name=meta_current_page]").val(data.meta.current_page)
            $("input[name=meta_from]").val(data.meta.from)
            $("input[name=meta_last_page]").val(data.meta.last_page)
            $("input[name=meta_per_page]").val(data.meta.per_page)
    ...
    <script>
        ...
        $('#container-barrio').on('click', '.owl-nav .owl-next',async function() {
             ...
             if(this.className.split(' ')[1]){ 
                ...
                let {  data: data } = await axios.get(`/api/development/buscar/propiedades-en-${type}-en-26663-a?page=${page+1}`)
