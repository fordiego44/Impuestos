        ...
        <div class="container mt-100">
            <div class="row">
                <div class="col-sm-12 col-md-7">
                    <h4>Aún no conocés La Lomada?</h4>
                    <h1 class="pxp-page-header">Conocé las características del barrio La Lomada</h1>
                </div>
            </div>
        </div>
                ...
                <div class="pxp-services-container rounded-lg mt-4 mt-md-5">
                    ...
                    <!-- <a href="{{asset('/masterplan/pilara.pdf')}}" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Conocé los barrios que<br> integran a La Lomada</div>
                        </div>
                    ...
                    <a href="https://goo.gl/maps/NoFUkmK1mHw9GJ5i8" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Desde Google Maps conocé <br/>como llegar a La Lomada.</div>
                        </div>
                    ...
                    <a href="https://wa.me/5491151856532" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            <div class="pxp-services-item-text-title">Te gustaría Visitar La Lomada?</div>
                            <div class="pxp-services-item-text-sub">Hablemos Vía <Strong>Whatsapp</strong> <br>Te esperamos en La Lomada.</div>
                        </div>
                ...
                <div class="col-sm-12 col-lg-10">
                    <div class="pxp-blog-post-block mt-4 mt-md-5 mt-lg-0">
                        ...
                        <div class="mt-3 mt-md-4">
                            <p class="pxp-first-letter">El country La Lomada se encuentra formado por 54 hectáreas, con 637 lotes de un promedio de 800 m2 a 1300 m2. Tiene un excelente acceso cerca de la Panamericana. </p>
                        </div>
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        ...
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Pileta de natación</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <div class="pxp-sp-amenities-item"><span class="fa fa-check"></span> Pileta de natación para mayores y menores</div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
