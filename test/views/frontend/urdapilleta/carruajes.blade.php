...
<div class="pxp-cta-1 pxp-cover  pt-300" style="background-image: url(/images/landings/carruajes-port.jpg); background-position: 50% 60%;">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-5 col-lg-5">
                <div class="pxp-cta-1-caption pxp-animate-in pxp-in">
                    <h2 class="pxp-section-h2">Barrio Cerrado Carruajes</h2>
                    <p class="pxp-text-light">El Lugar para Vivir.</p>
                    <a href="../buscar/propiedades-en-urdapilleta-en-26726-c" class="pxp-primary-cta text-uppercase mt-3 mt-md-5 pxp-animate">Todas las propiedades en <strong>Carruajes</strong></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid pxp-props-carousel-right mt-100">
    <h2 class="pxp-section-h2">Propiedades en Carruajes</h2>
    <p class="pxp-text-light">Ver propiedades en: <a style="color: #729acd; cursor: pointer;"  id='en-venta' >En Venta</a> | <a style="color: #729acd; cursor: pointer;"  id='en-alquiler'>En Alquiler</a> | <a href="../buscar/propiedades-en-urdapilleta-en-26726-c">Ver Todas</a></p>
...
<div class="pxp-content">
    ...
    <div class="pxp-blog-posts pxp-content-wrapper mt-60">
        <div class="container mt-100">
            <div class="row">
                <div class="col-sm-12 col-md-7">
                    <h4>Aún no conocés Carruajes?</h4>
                    <h1 >Conocé todos los departamentos en Venta y Alquiler en el Condominio Carruajes </h1>
                </div>
            </div>
        </div>
                ...
                <div class="pxp-services-container rounded-lg mt-4 mt-md-5">
                    ...
                    <!-- <a href="{{asset('/masterplan/pilara.pdf')}}" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Conocé los barrios que<br> integran a Carruajes</div>
                        </div>
                    ...
                    <a href="https://goo.gl/maps/HALqzqCfoMgrU11D8" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Desde Google Maps conocé <br/>como llegar a Carruajes.</div>
                        </div>
                    ...
                    <a href="https://wa.me/5491151856532" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            <div class="pxp-services-item-text-title">Te gustaría Visitar Carruajes?</div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-10">
                    <div class="pxp-blog-post-block mt-4 mt-md-5 mt-lg-0">
                        <h2>Carruajes, Condominio en Pilará</h2>
                        <div class="mt-3 mt-md-4">
                            <p >Dos módulos de (8 y 4) departamentos de 2 y 3 dormitorios, en PB o Primer Piso. </p>
                        </div>
                         <!-- <div class="mt-3 mt-md-4">
                    ...
                    <div class="pxp-blog-post-block pxp-full mt-4 mt-md-5">
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <img src={{asset('/images/landings/carruajes-1.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
                            
                            <div class="col-sm-12 col-md-6">
                                <img src={{asset('/images/landings/carruajes-2.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
                            <div class="col-sm-12 col-md-12">
                                <img src={{asset('/images/landings/carruajes-port.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        <!-- <h2>Servicios del barrio Carruajes: </h2>
                        <div class="mt-3 mt-md-4">
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        ...
                        <!-- <h2>Infraestructura del barrio Carruajes: </h2>
                        <div class="mt-3 mt-md-4">
                            <div class="row mt-3 mt-md-4">
                        ...
                        <div class="mt-3 mt-md-4">
                        <h2>Ubicación de Carruajes </h2>
                            <p>Condominios dentro de Pilará, a metros del Club House de Golf. </p>
                        </div>
        ...
        <div class="pxp-blog-post-hero mt-4 mt-md-5">
            <div class="pxp-blog-post-hero-fig pxp-cover" style="background-image: url(/images/landings/carruajes-port.jpg); background-position: 50% 60%;"></div>
        </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/axios/0.19.2/axios.js"></script>
    <script>
        $('#en-venta').on('click', async function() { 
            let page = 1; 
            let {  data: data } = await axios.get(`/api/development/buscar/propiedades-en-venta-en-26726-v?page=${page}`)
        ...
        $('#en-alquiler').on('click',async function() {
            ...
            let page = 1; 
             let {  data: data } = await axios.get(`/api/development/buscar/propiedades-en-alquiler-en-26726-v?page=${page}`)
             htmlPropertiesNew(data.objects);
    ...
    <script>
        ...
        $('#container-barrio').on('click', '.owl-nav .owl-next',async function() {
             ...
             if(this.className.split(' ')[1]){ 
                ...
                let {  data: data } = await axios.get(`/api/development/buscar/propiedades-en-${type}-en-26726-v?page=${page+1}`)
