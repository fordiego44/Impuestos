...
<div class="pxp-cta-1 pxp-cover  pt-300" style="background-image: url(/images/landings/skyglass-port.jpg); background-position: 50% 60%;">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-5 col-lg-5">
                <div class="pxp-cta-1-caption pxp-animate-in pxp-in">
                    <h2 class="pxp-section-h2">Oficinas Skyglass</h2>
                    <p class="pxp-text-light">El mejor lugar para tu oficina.</p>
                    <a href="../buscar/propiedades-en-urdapilleta-en-26736-s" class="pxp-primary-cta text-uppercase mt-3 mt-md-5 pxp-animate">Todas las propiedades en <strong>Skyglass</strong></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid pxp-props-carousel-right mt-100">
    <h2 class="pxp-section-h2">Propiedades en Skyglass</h2>
    <p class="pxp-text-light">Ver propiedades en: <a style="color: #729acd; cursor: pointer;"  id='en-venta' >En Venta</a> | <a style="color: #729acd; cursor: pointer;"  id='en-alquiler'>En Alquiler</a> | <a href="../buscar/propiedades-en-urdapilleta-en-26736-s">Ver Todas</a></p>
...
<div class="pxp-content">
    ...
    <div class="pxp-blog-posts pxp-content-wrapper mt-60">
        <div class="container mt-100">
            <div class="row">
                <div class="col-sm-12 col-md-7">
                    ...
                    <h1 class="pxp-page-header">Oficinas disponibles en el Edificio Skyglass Pilar </h1>
                </div>
            </div>
        </div>
        ...
        <div class="pxp-services pxp-cover mt-60 pt-100 mb-200" style="background-image: url(/images/testim-1-fig.jpg);">
            ...
            <div class="container">
                <div class="pxp-services-container rounded-lg mt-4 mt-md-5">
                    <a href="{{asset('/masterplan/MASTERPLAN-SKYGLASS.pdf')}}" target="_blank" class="pxp-services-item">
                    ...
                    <!-- <a href="{{asset('/masterplan/Skyglass.pdf')}}" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Conocé los barrios que<br> integran a Skyglass</div>
                        </div>
                    ...
                    <a href="https://goo.gl/maps/PQx8FoYjjBQHHNiH6" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Desde Google Maps conocé <br/>como llegar a Skyglass.</div>
                        </div>
                    ...
                    <a href="https://wa.me/5491151856532" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            <div class="pxp-services-item-text-title">Te gustaría Visitar Skyglass?</div>
                            <div class="pxp-services-item-text-sub">Hablemos Vía <Strong>Whatsapp</strong> <br>Te esperamos en Skyglass.</div>
                        </div>
                ...
                <div class="col-sm-12 col-lg-10">
                    <div class="pxp-blog-post-block mt-4 mt-md-5 mt-lg-0">
                        ...
                        <div class="mt-3 mt-md-4">
                            <p class="pxp-first-letter">Skyglass es parte de Ayres Vila, el polo urbano desarrollado por Ayres Desarrollos. Es un espacio de 17 hectáreas con edificios que ofrecen soluciones de vivienda, oficinas y comercios. </p>
                        </div>
                    ...
                    <div class="pxp-blog-post-block pxp-full mt-4 mt-md-5">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <img src={{asset('/images/landings/skyglass-2.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
                            
                            <div class="col-sm-12 col-md-6">
                                <img src={{asset('/images/landings/skyglass-3.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
                            <div class="col-sm-12 col-md-12">
                                <img src={{asset('/images/landings/skyglass-4.jpg')}} alt="" class="pxp-image-full mb-3">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        ...
                        <p>El edificio Skyglass cuenta con oficinas de 75 a 300 m2, con cocheras subterráneas. Las oficinas de SKYGLASS son muy luminosas ya que tienen por lo menos una pared entera de vidrio.   </p>
                        
                    </div>

                    <div class="pxp-blog-post-block mt-4 mt-md-5">
                        <h2>Alrededores y comodidades del Edificio Skyglass</h2>
        ...
        <div class="pxp-blog-post-hero mt-4 mt-md-5">
            <div class="pxp-blog-post-hero-fig pxp-cover" style="background-image: url(/images/landings/skyglass-port.jpg); background-position: 50% 60%;"></div>
        </div>
