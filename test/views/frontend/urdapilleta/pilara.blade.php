        ...
        <div class="row">
            <div class="col-sm-12 col-md-5 col-lg-5">
                <div class="pxp-cta-1-caption pxp-animate-in pxp-in">
                    ...
                    <a href="../buscar/propiedades-en-urdapilleta-en-26677-p" class="pxp-primary-cta text-uppercase mt-3 mt-md-5 pxp-animate">Todas las propiedades en <strong>Pilará</strong></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid pxp-props-carousel-right mt-100">
    ...
    <p class="pxp-text-light">Ver propiedades en: <a style="color: #729acd; cursor: pointer;"  id='en-venta' >En Venta</a> | <a style="color: #729acd; cursor: pointer;"  id='en-alquiler'>En Alquiler</a> | <a href="../buscar/propiedades-en-urdapilleta-en-26677-p">Ver Todas</a></p>
        ...
        <div class="pxp-services pxp-cover mt-60 pt-100 mb-200" style="background-image: url(/images/testim-1-fig.jpg);">
            ...
            <div class="container">
                <div class="pxp-services-container rounded-lg mt-4 mt-md-5">
                    <a href="{{asset('/masterplan/MASTERPLAN-PILARA.pdf')}}" target="_blank" class="pxp-services-item">
                    ...
                    <a href="https://wa.me/5491151856532" target="_blank" class="pxp-services-item">
                        ...
                        <div class="pxp-services-item-text text-center">
                            ...
                            <div class="pxp-services-item-text-sub">Hablemos Vía <Strong>Whatsapp</strong> <br>Te esperamos en Pilará.</div>
                        </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/axios/0.19.2/axios.js"></script>
    <script>
        $('#en-venta').on('click', async function() { 
            let page = 1; 
            let {  data: data } = await axios.get(`/api/development/buscar/propiedades-en-venta-en-26677-p?page=${page}`)
        ...
        $('#en-alquiler').on('click',async function() {
            ...
            let page = 1; 
             let {  data: data } = await axios.get(`/api/development/buscar/propiedades-en-alquiler-en-26677-p?page=${page}`)
             htmlPropertiesNew(data.objects);
    ...
    <script>
        ...
        $('#container-barrio').on('click', '.owl-nav .owl-next',async function() {
             ...
             if(this.className.split(' ')[1]){ 
                ...
                let {  data: data } = await axios.get(`/api/development/buscar/propiedades-en-${type}-en-26677-p?page=${page+1}`)
        ...
        function htmlProperties(data) {
            ...
            for (let i = 0; i < data.length; i++) {
                    ...
                    html[i] = `  
                            <a href="/propiedad/${data[i].id}-${data[i].title_href}" class="pxp-prop-card-1 rounded-lg">
