			...
			<div class=" ">
				...
				<article id="post-38" class="col-md-12 post-38 page type-page status-publish hentry">
					<div class="col-lg-5 col-md-4 col-md-offset-3 sign-in-form style-1 margin-bottom-45">
						...
						<ul class="tabs-nav"> 
							<li  class="active"><a href="#tab4">Repartidor</a></li>
 						</ul>

						<div class="tabs-container alt"> 
							<div class="tab-content" id="tab4"  style="display: none">
								<form  class="login"> 
									<div id="register-repartidor-result"> </div>
...
<div class="clearfix"></div>  
		...
		<script type="text/javascript" src={{asset('js/frontend/auth_repartidor.js')}}></script>  
