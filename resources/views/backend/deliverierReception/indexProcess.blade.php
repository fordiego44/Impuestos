      ...
      @foreach ($reception as $receptions)
				<li class="user-booking waiting-booking" style="padding: 0px 30px;" id="booking-list-10046">
							...
							<div class="buttons-to-right">
								<a href="/admin/recepciones/realizado/{{$receptions[0]->pending}}/1" class="button gray  " ><i class="sl sl-icon-close"></i> Realizado</a>
								<a href="/admin/recepciones/anulado/{{$receptions[0]->pending}}/1" class="button gray  "  ><i class="sl sl-icon-close"></i> Anulado</a>
