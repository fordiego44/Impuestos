					...
					<nav id="breadcrumbs">
						<ul>
							@if ($message2[0] == "administrador")
								...
								<li><a href="/admin/recepciones/anulado">Cancelados</a></li>
							@else
								<li><a href="#">Dashboard</a></li>
								<li><a href="#">Recepción</a></li>
								<li><a href="/admin/repartidor/recepciones/anulado">Cancelados</a></li>
							@endif
						</ul>
					</nav>
				</div>
...
<div class="col-lg-12 col-md-12">
		...
		<div class="dashboard-list-box margin-top-0">
			<div class="list-box-listing">
				<div>
					<h4 style="background-color: #f7f7f7; border-bottom: 0px solid #eaeaea;">Pedidos cancelados</h4>
				</div>
