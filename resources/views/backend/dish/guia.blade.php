...
<div class="dashboard-content" id="post-45">
			...
			<div class="row">
				<div class="col-md-12">
					<div style="display:inline-block;width: 100%;max-width: 550px;">
						<h1>Manual de uso de productos</h1>
						<nav id="breadcrumbs">
  						<ul>
		...
		<div class="col-lg-12 col-md-12">
				...
				<div class="style-1">
					<!-- Tabs Navigation -->
					<ul class="tabs-nav">
						<li class="active"><a href="#tab1a">Generar nuevo propucto</a></li>
						<li class=""><a href="#tab2a">Editar producto</a></li>
						<li class=""><a href="#tab3a">Eliminar producto</a></li>
					</ul>
									...
									<div class="add-listing-section margin-top-0" style="padding-top: 25px;">
										...
										<div class="submit-section">
												 	<video width="100%" height="480px" controls preload>
													    <source src="{{URL::asset('video/producto1.mp4')}}" type="video/mp4">
													</video>
										</div>
									</div>
							...
							<div class="col-lg-12 col-md-12" >
								...
								<div class="dashboard-list-box margin-top-0">
									...
									<div class="add-listing-section margin-top-0" style="padding-top: 25px;">
										...
										<div class="submit-section">
												 	<video width="100%" height="480px" controls preload>
													    <source src="{{URL::asset('video/producto2.mp4')}}" type="video/mp4">
													</video>
										</div>
									</div>
							...
							<div class="col-lg-12 col-md-12" >
								...
								<div class="dashboard-list-box margin-top-0">
									...
									<div class="add-listing-section margin-top-0" style="padding-top: 25px;">
										...
										<div class="submit-section">
												 	<video width="100%" height="480px" controls preload>
													    <source src="{{URL::asset('video/producto3.mp4')}}" type="video/mp4">
													</video>
										</div>
									</div>
